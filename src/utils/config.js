...
function getBaseWebpackPartial(options) {
    ...
    const webpackConfig = {
        ...
        output: {
            ...
            filename: (pathData) => {
                return pathData.chunk.name === 'main' ? options.outputFileName : exports.OUT_FILENAME_TEMPLATE;
            },
        ...
        plugins: [
            ...
            new webpack_1.DefinePlugin({
                __BUILD_VERSION__: JSON.stringify(require((0, path_1.join)(options.root, "package.json")).version),
