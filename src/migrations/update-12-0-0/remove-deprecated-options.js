...
function update(host) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        for (const [name, config] of projects.entries()) {
            if (config.targets.build.executor !== 'nx-electron:build')
                return;
            let updated = false;
            ...
            if (updated) {
                ...
                devkit_1.logger.info(`nx-electron removed legacy build option from "${name}": showCircularDependencies`);
            }
        }
...
//# sourceMappingURL=remove-deprecated-options.js.map